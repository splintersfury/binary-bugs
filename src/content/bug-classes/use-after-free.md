...
In a multithreaded or event-driven program, the gap between `free` and reuse can be large, making UAFs especially common in browsers, kernels, and complex daemons.
...
1. Control the next allocation of that size, and
...
Before moving to case studies, I should understand:
...
- [ ] How to groom the heap so my controlled allocation reclaims the exact same slot.
